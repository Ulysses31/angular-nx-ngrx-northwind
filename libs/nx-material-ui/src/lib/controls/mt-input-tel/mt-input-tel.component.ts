...
@Component({
  selector: 'nx-northwind-mt-input-tel',
  ...
  styleUrls: ['./mt-input-tel.component.scss'],
  providers: [
    {
...
export class MtInputTelComponent implements OnInit {
  ...
  constructor() {
    console.log('nx-northwind-mt-input-tel constructor...');
  }

  ngOnInit(): void {
    console.log('nx-northwind-mt-input-tel OnInit...');
  }
