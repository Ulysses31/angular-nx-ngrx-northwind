...
DocumentContext.prototype.calculateBottomMost = function (
  destContext
) {
  if (this.endingCell) {
...
function pageOrientation(
  ...
  if (pageOrientationString === undefined) {
    ...
    isString(pageOrientationString) &&
    pageOrientationString.toLowerCase() === 'landscape'
  ) {
    return 'landscape';
  } else {
    return 'portrait';
...
DocumentContext.prototype.moveToNextPage = function (
  pageOrientation
) {
  ...
  if (createNewPage) {
    ...
    var currentPageOrientation =
      this.getCurrentPage().pageSize.orientation;
...
DocumentContext.prototype.getCurrentPosition = function () {
  ...
  var innerHeight =
    pageSize.height - this.pageMargins.top - this.pageMargins.bottom;
  var innerWidth =
    pageSize.width - this.pageMargins.left - this.pageMargins.right;
